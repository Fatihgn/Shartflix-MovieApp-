...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/match.png
  AssetGenImage get match => const AssetGenImage('assets/images/match.png');
  ...
  /// File path: assets/images/recom.png
  AssetGenImage get recom => const AssetGenImage('assets/images/recom.png');
...
class $AssetsLottieGen {
  ...
  /// File path: assets/lottie/Movie.json
  LottieGenImage get movie => const LottieGenImage('assets/lottie/Movie.json');
  ...
  /// List of all assets
  List<LottieGenImage> get values => [movie, animZombie];
}
